...
function AddBeer() {
    ...
    const handleAttenuationLevelInput = (e) => setAttenuationLevel.apply(e.target.value);
    const handleContributedByInput = (e) => setContributedBy.apply(e.target.value);
    ...
    const handleSubmit = (e) => {
      ...
      .then((response) => {
        ...
        setName("");
        setContributedBy('/') // => redirects to homepage
      });
