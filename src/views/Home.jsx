...
export default function Home() {
    return (
        <div className="Home__container">
            <div>
                <div className="Home_image"><img src={beerImg} alt="beers"/></div>
            ...
            <div>
                <div className="Home_image"><img src={radomBeerImg} alt="random-beer"/></div>
            ...
            <div>
                <div className="Home_image"><img src={newBeerImg} alt="new-beer"/></div>
