          ...
          <div className="card mb-2" style={{ width: "26rem" }}>
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Explore a collection of beers crafted by various brewers and
                breweries.
              </p>
            </div>
          </div>
        ...
        <Link to="/random-beer">
          <div className="card mb-2" style={{ width: "26rem" }}>
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Discover unique beers with intriguing details at random, one
                beer at a time.
              </p>
            </div>
          </div>
        ...
        <Link to="/new-beer">
          <div className="card" style={{ width: "26rem" }}>
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Unleash your inner brewmaster and share your latest creation
