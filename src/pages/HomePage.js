  ...
  return (
    <>
      ...
      <div className='section'>
        <img className="responsive" src="/images/beers.png" alt="All beer img" />
      ...
      <Link to='/random-beer'>
      <div className='section'>
        <img className="responsive" src="/images/random-beer.png" alt="All beer img" />
        <div className='section-verbage'> 
          <h2>Random Beer</h2>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut porttitor leo a diam sollicitudin. Libero enim sed faucibus turpis in eu.</p>
        </div>
      ...
      <Link to='/new-beer'>
      <div className='section'>
        <img className="responsive" src="/images/new-beer.png" alt="All beer img" />
        <div className='section-verbage'> 
          <h2>New Beer</h2>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut porttitor leo a diam sollicitudin. Libero enim sed faucibus turpis in eu.</p>
        </div>
