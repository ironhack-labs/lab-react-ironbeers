...
export default function RandomBeer(props) {
    ...
    const getBeer = async () => {
      const beers = await axios.get(`https://ih-beers-api2.herokuapp.com/beers/random`);
      setBeer(beers.data);
    }
    useEffect(() => {
        getBeer();    
    ...
    return (
        <div className='py-5'>
            {
            <div className='flex flex-col justify-center items-center place-items-center justify-items-center py-5'>
