        ...
        <div className="card" style={{ width: "100rem" }}>
          ...
          <div className="card-body">
            ...
            <p className="card-text">
              ...
              placerat elementum magna, in gravida odio dictum et. In laoreet
              pretium arcu, at finibus lectus. Aenean venenatis lobortis
              maximus. Duis quis enim id sapien eleifend varius. Suspendisse
              accumsan volutpat urna id maximus
            </p>
          </div>
        </div>
      </Link>
