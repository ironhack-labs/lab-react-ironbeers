...
const Home = () => {
    ...
    return (
        <div>
            <div>
                <Link to='/beers'><img src={'/images/beers.png'} alt='collection of beers' className='img-fluid' /></Link>
                <h2>All Beers</h2>
            ...
            <div>
                <Link to='/random-beer'><img src={'/images/random-beer.png'} alt='beer on tap' className='img-fluid' /></Link>
                <h2>Random Beer</h2>
            ...
            <div>
                <Link to='/new-beer'><img src={'/images/new-beer.png'} alt='glass of beer' className='img-fluid' /></Link>
                <h2>New Beer</h2>
