...
const Home = () => {
    ...
    return (
        <div>
            ...
            <div>
                <Link to='/random-beer'><img src={process.env.PUBLIC_URL + 'images/random-beer.png'} alt='beer on tap' className='img-fluid' /></Link>
                <h2>Random Beer</h2>
            ...
            <div>
                <Link to='/new-beer'><img src={process.env.PUBLIC_URL + 'images/new-beer.png'} alt='glass of beer' className='img-fluid' /></Link>
                <h2>New Beer</h2>
