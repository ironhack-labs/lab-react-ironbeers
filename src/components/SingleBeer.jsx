            ...
            <div>
                ...
                <div className='d-flex flex-column'>
                    <div className='align-self-center py-5'>
                        <img style={{height: '250px'}} src={beer.image_url} alt={beer.name} />
                    </div>    
                </div>
                ...
                <p className='px-4 description-beer'><b>{beer.description}</b></p>
                <p className='px-4 text-secondary'><b>{beer.contributed_by}</b></p>
            </div>
        )
    }
}
