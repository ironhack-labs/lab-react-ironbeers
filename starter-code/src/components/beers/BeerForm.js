...
class NewBeer extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <Card title="Add new beer" style={{ width: '50vw', textAlign:'center', fontWeight:'Bold' }}>
          ...
          <Form onSubmit={this.onSubmit}>
            ...
            <Form.Item>
              <Input type="submit" value="Add" style={{background:'rgb(0, 174, 255)', color:'white', fontWeight:'Bolder'}}/>  
            </Form.Item>
          </Form>
        </Card>
      </div>
