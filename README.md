...
Well, at this point, this comes natural: we will use `vite` to build a new app. Feel free to name it as you wish, but if you need some inspiration, we called it **Reactive BeersJS**. -->
